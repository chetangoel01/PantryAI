...
def parse_receipt_google(raw_text: str) -> list[dict]:
    ...
    prompt = (
        ...
        "- `itemCategory`: string (e.g., 'Dairy', 'Baked Goods', 'Produce', 'Beverages', 'Cleaning Supplies'). "
          "Infer the most specific category based on the item name and common pantry classifications. "
          "If uncertain, use a broader category or 'Uncategorized'.\n"
        ...
        "- `itemUnit`: string or null (e.g., 'gallon', 'oz', 'lbs', 'bag', 'each'). "
          "Extract explicit units. If no unit is specified but a quantity is, infer 'each' or 'unit'.\n"
